function opennew(a) {
    $.ajax({
        url: a.data("url"), success: function (b) {
...
!function (a) {
        ...
        a.ajax({
            url: b, success: function (b) {
                a(".project-content").html(b), a(".project-content").hide(0), a(".project-window").hide(0), c(), a("html, body").animate({scrollTop: a("#project-show").offset().top - 200}, 300, function () {
                    ...
                    a(".project-window").animate({height: b}, 500, function () {
    ...
    function c() {
        a(".close-btn").click(function () {
            a(".project-window").slideUp("slow"), a(".project-content").fadeOut("slow"), a("html, body").animate({scrollTop: a("#discography").offset().top - 50}, 1e3), f = !1
        })
    }

    function d() {
        var b = a("#playlist0"), c = audiojs.create(b, {
            trackEnded: function () {
...
var $actualnew = null, openednew = !1;
$(".open-new").click(function () {
    return opennew($(this)), $actualnew = $(this), $actualnew.parent().addClass("open"), !1
}), function (a) {
    a.fn.extend({
        scrollWindow: function (b) {
            var c = {duration: "slow", easing: "swing"}, b = a.extend(c, b), d = function (c) {
                a("html,body").animate({scrollTop: a(c).offset().top}, b.duration, b.easing, function () {
                    location.hash = c
                })
            };
        ...
        function b() {
            ...
            }), c = b[0], d = a("ol.playlist a").attr("data-src");
        ...
        time: {
            Days: {text: "Days", color: "#EB2B29", show: !0},
            Hours: {text: "Hours", color: "#EB2B29", show: !0},
            Minutes: {text: "Minutes", color: "#EB2B29", show: !0},
            Seconds: {text: "Seconds", color: "#EB2B29", show: !0}
        }
        ...
        function c() {
            function b(b) {
                for (var c = b.length, d = 0, e = document.getElementById("twitter-feed"),
                         f = '<ul class="slider-twitter">'; c > d;)f += '<li class="gallery-cell">' + b[d] + "</li>", d++;
        ...
        var b = a(".upevents").isotope({itemSelector: ".upevent", masonry: {columnWidth: ".upevent"}}),
            b = a(".thumbnails").isotope({itemSelector: ".thumbnail", masonry: {columnWidth: ".thumbnail.small"}});
        ...
        if (location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
            ...
            if (b = b.length && b || a("[name=" + this.hash.slice(1) + "]"), b.length) {
                var c = b.offset().top;
                return a("html,body").animate({scrollTop: c - 42}, 1e3), a(".navbar-collapse.in").removeClass("in").addClass("collapse"), !1
            }
        }
    }), a(function () {
        a(window).bind("scroll", function () {
            a("body.overflowed").length < 1 && (a(window).scrollTop() >= 85 ? a("#jHeader").addClass("overflow") : a("#jHeader").removeClass("overflow")), a(window).scrollTop() >= a(".jIntro").height() / 2 ? a("#jHeader").addClass("fixed") : a("#jHeader").removeClass("fixed")
        }), a(".disc-tracklist").on("click", function () {
            alert("CLICK")
        })
    }), a("#more-events").click(function () {
        return a(".upcomming-events-list li.more").slideToggle("slow"), a(this).hide(), !1
    })
}(jQuery);